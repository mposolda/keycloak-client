...
You can even generate your own keystore from the {project_name} Admin Console if you don't have your own available. This option is the easiest when using authorization client.

For set up of this method, you need to have something like this in your `keycloak.json` file:
